...
export const CANONICAL_TRANSLATION_KEYS = [
  ...
  'account.profile.menu.theme.dark',
  'account.profile.menu.theme.light',
  'account.profile.menu.theme.subtitle',
  'account.profile.menu.theme.system',
  'account.profile.menu.theme.title',
