...
export const CANONICAL_TRANSLATION_KEYS = [
  ...
  'account.profile.about.page.rows.licenses',
  ...
  'account.profile.about.page.sections.help',
  ...
  'account.profile.about.page.title',
  'account.profile.about.subtitle',
  'account.profile.about.title',
  'account.profile.about.versionLabel',
  'account.profile.comingSoon.badge',
  'account.diabetesManagement.page.title',
  'account.diabetesManagement.page.description',
  'account.diabetesManagement.glucose.title',
  ...
  'account.diabetesManagement.target.title',
  'account.diabetesManagement.target.notSet',
  'account.diabetesManagement.target.editAction',
  'account.diabetesManagement.target.remove',
  ...
  'account.diabetesManagement.saved',
  'account.diabetesManagement.saving',
  ...
  'account.profile.menu.devices.title',
  'account.profile.menu.export.subtitle',
  'account.profile.menu.export.title',
  'account.profile.menu.language.subtitle',
  'account.profile.menu.language.title',
  'account.profile.language.page.title',
  'account.profile.language.page.description',
  'account.profile.language.option.selected',
  'account.profile.menu.section.data',
  'account.profile.menu.section.devices',
  'account.profile.menu.section.diabetesManagement',
  'account.profile.menu.section.personalization',
  'account.profile.segments.profile',
  'account.profile.segments.security',
  'account.profile.segments.settings',
  'account.profile.settings.description',
  'account.profile.settings.theme.dark',
  'account.profile.settings.theme.light',
  'account.profile.settings.theme.subtitle',
  'account.profile.settings.theme.title',
  'account.profile.settings.title',
  'account.profile.subtitle',
  'account.profile.title',
  'account.profile.userCard.avatarLabel',
  ...
  'account.auth.signIn.title',
  'account.auth.signIn.description',
  'account.auth.signIn.continue',
  'account.auth.signIn.sending',
  'account.auth.signIn.emailLabel',
  'account.auth.signIn.emailHint',
  'account.auth.signIn.orEmail',
  'account.auth.signIn.passkey',
  'account.auth.signIn.passkeyPending',
  'account.auth.signIn.passkeyError',
  'account.auth.signIn.disclaimer',
  'account.auth.signIn.returnToApp',
  'account.auth.checkEmail.title',
  ...
  'account.auth.checkEmail.returnToApp',
  'account.auth.error.title',
  'account.auth.error.description',
  'account.auth.error.backToSignIn',
  ...
  'dashboard.lastGlucose.time.justNow',
  'dashboard.lastGlucose.time.today',
  'dashboard.lastGlucose.time.yesterday',
  ...
  'dashboard.daySummary.chartAria.insulin.none',
  'dashboard.daySummary.chartAria.insulin.single',
  ...
  'timeline.dateFilter.apply',
  'timeline.dateFilter.ariaLabel',
  'timeline.dateFilter.closeOverlay',
  'timeline.dateFilter.last45Days',
  'timeline.dateFilter.last30Days',
  'timeline.dateFilter.last7Days',
  'timeline.dateFilter.sheetTitle',
  'timeline.dateFilter.today',
  'timeline.dayEmpty.description',
  'timeline.dayEmpty.title',
  'timeline.dayNavigation.ariaLabel',
  'timeline.dayNavigation.nextDay',
  'timeline.dayNavigation.previousDay',
  'timeline.dayNavigation.todayPrefix',
  'timeline.dayPeriod.day',
  'timeline.dayPeriod.evening',
  'timeline.dayPeriod.morning',
  'timeline.dayPeriod.night',
  ...
  'timeline.eventCount.few',
  'timeline.eventCount.many',
  'timeline.eventCount.one',
  'timeline.eventCount.other',
  'timeline.eventsOfDay.ariaLabel',
  ...
  'timeline.eventsOfDay.currentTime',
  'timeline.eventsOfDay.helper',
  'timeline.eventsOfDay.title',
  ...
  'timeline.insulinContext.after_meal',
  'timeline.insulinContext.basal',
  'timeline.insulinContext.before_meal',
  'timeline.insulinContext.correction',
  'timeline.insulinContext.other',
  'timeline.insulinContext.unspecified',
  ...
  'timeline.insulinPreparation.other',
  'timeline.insulinGrouping.long_acting',
  'timeline.insulinGrouping.rapid_acting',
  'timeline.insulinGrouping.unspecified',
  ...
  'timeline.detail.nutrition.items',
  ...
  'quick-add.glucose.contextLabel',
  'quick-add.glucose.contextSheetTitle',
  'quick-add.glucose.addContext',
  'quick-add.glucose.changeContext',
  'quick-add.glucose.clearContext',
  ...
  'quick-add.note.saveError.title',
  'quick-add.note.saving',
  'quick-add.nutrition.addItem',
  'quick-add.nutrition.cancel',
  'quick-add.nutrition.carbsError',
  'quick-add.nutrition.carbsLabel',
  'quick-add.nutrition.carbsPer100Label',
  'quick-add.nutrition.carbsPlaceholder',
  'quick-add.nutrition.carbsUnit',
  'quick-add.nutrition.categoryDescription',
  'quick-add.nutrition.categoryLabel',
  'quick-add.nutrition.demoProduct.apple',
  'quick-add.nutrition.demoProduct.banana',
  'quick-add.nutrition.demoProduct.milk',
  'quick-add.nutrition.demoProduct.oatmealCooked',
  'quick-add.nutrition.demoProduct.plainYogurt',
  'quick-add.nutrition.demoProduct.potatoBoiled',
  'quick-add.nutrition.demoProduct.riceBoiled',
  'quick-add.nutrition.demoProduct.wholegrainBread',
  'quick-add.nutrition.itemAriaLabel',
  'quick-add.nutrition.itemCarbsLabel',
  'quick-add.nutrition.itemLabel',
  'quick-add.nutrition.itemPlaceholder',
  'quick-add.nutrition.itemSheetTitle',
  'quick-add.nutrition.itemsHeading',
  'quick-add.nutrition.itemsHelp',
  'quick-add.nutrition.mealTypeLabel',
  'quick-add.nutrition.mealTypePlaceholder',
  'quick-add.nutrition.mealTypeSheetTitle',
  'quick-add.nutrition.mode.items',
  'quick-add.nutrition.mode.manual',
  'quick-add.nutrition.modeLegend',
  'quick-add.nutrition.noteLabel',
  'quick-add.nutrition.noteOptional',
  'quick-add.nutrition.notePlaceholder',
  'quick-add.nutrition.removeItem',
  'quick-add.nutrition.save',
  'quick-add.nutrition.saveError.description',
  'quick-add.nutrition.saveError.title',
  'quick-add.nutrition.saving',
  'quick-add.nutrition.timeLabel',
  'quick-add.nutrition.title',
  'quick-add.nutrition.totalCarbsLabel',
  'quick-add.nutrition.weightError',
  'quick-add.nutrition.weightLabel',
