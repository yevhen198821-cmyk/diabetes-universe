...
export const englishCanonicalMessages = defineApprovedMessages({
  ...
  'timeline.mealType.unspecified': 'Not specified',
  ...
  'quick-add.nutrition.carbsError':
    'Enter carbohydrates greater than 0 and no more than 500 g.',
  'quick-add.nutrition.carbsLabel': 'Carbohydrates',
  'quick-add.nutrition.carbsPer100Label': 'g carbs / 100 g',
  'quick-add.nutrition.carbsPlaceholder': '42',
  'quick-add.nutrition.carbsUnit': 'g',
  'quick-add.nutrition.categoryDescription': 'Log a meal',
  'quick-add.nutrition.categoryLabel': 'Nutrition',
  'quick-add.nutrition.demoProduct.apple': 'Apple',
  'quick-add.nutrition.demoProduct.banana': 'Banana',
  'quick-add.nutrition.demoProduct.milk': 'Milk',
  'quick-add.nutrition.demoProduct.oatmealCooked': 'Cooked oatmeal',
  'quick-add.nutrition.demoProduct.plainYogurt': 'Plain yogurt',
  'quick-add.nutrition.demoProduct.potatoBoiled': 'Boiled potato',
  'quick-add.nutrition.demoProduct.riceBoiled': 'Boiled rice',
  'quick-add.nutrition.demoProduct.wholegrainBread': 'Wholegrain bread',
  'quick-add.nutrition.itemAriaLabel': 'Item',
  'quick-add.nutrition.itemCarbsLabel': 'Carbohydrates',
  'quick-add.nutrition.itemLabel': 'Item',
  'quick-add.nutrition.itemPlaceholder': 'Select an item',
  'quick-add.nutrition.itemSheetTitle': 'Item',
  'quick-add.nutrition.itemsHeading': 'Items',
  'quick-add.nutrition.itemsHelp':
    'The demo catalogue is for the interface only and is not a medical or regulatory food database.',
  'quick-add.nutrition.mealTypeLabel': 'Meal type',
  'quick-add.nutrition.mealTypePlaceholder': 'Select a meal type',
  'quick-add.nutrition.mealTypeSheetTitle': 'Meal type',
  'quick-add.nutrition.mode.items': 'Items',
  'quick-add.nutrition.mode.manual': 'Total carbs',
  'quick-add.nutrition.modeLegend': 'How to enter carbohydrates',
  'quick-add.nutrition.noteLabel': 'Note',
  'quick-add.nutrition.noteOptional': 'optional',
  ...
  'quick-add.nutrition.weightError':
    'Weight must be greater than 0 and no more than 3000 g.',
  'quick-add.nutrition.weightLabel': 'Serving weight',
