...
export const englishCanonicalMessages = defineApprovedMessages({
  ...
  'account.profile.about.subtitle': 'Version, licences, and support',
  ...
  'account.profile.menu.theme.dark': 'Dark',
  'account.profile.menu.theme.light': 'Light',
  'account.profile.menu.theme.subtitle': 'Light / Dark / System',
  'account.profile.menu.theme.system': 'System',
  'account.profile.menu.theme.title': 'App theme',
  ...
  'account.profile.settings.description':
    'Additional account settings will appear here in a future update.',
