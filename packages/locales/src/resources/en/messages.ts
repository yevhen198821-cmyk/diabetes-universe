...
export const englishCanonicalMessages = defineApprovedMessages({
  ...
  'timeline.eventsOfDay.clusterAriaLabel': '{count} events close together',
  ...
  'timeline.dayPeriod.eventCount.one': '{count} event',
  'timeline.dayPeriod.eventCount.few': '{count} events',
  'timeline.dayPeriod.eventCount.many': '{count} events',
  'timeline.dayPeriod.eventCount.other': '{count} events',
