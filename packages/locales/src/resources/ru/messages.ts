...
export const russianDraftMessages = defineDraftMessages({
  ...
  'timeline.eventsOfDay.clusterAriaLabel': '{count} события рядом',
  ...
  'timeline.dayPeriod.eventCount.one': '{count} событие',
  'timeline.dayPeriod.eventCount.few': '{count} события',
  'timeline.dayPeriod.eventCount.many': '{count} событий',
  'timeline.dayPeriod.eventCount.other': '{count} событий',
});
