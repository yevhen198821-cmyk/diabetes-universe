...
export const russianCanonicalMessages = defineApprovedMessages({
  ...
  'timeline.mealType.unspecified': 'Не указано',
  ...
  'quick-add.insulin.saveError.description':
    'Запись об инсулине не сохранена. Введённые значения остались в форме. Попробуйте ещё раз.',
  ...
  'quick-add.nutrition.carbsLabel': 'Углеводы',
  'quick-add.nutrition.carbsPer100Label': 'г углеводов / 100 г',
  'quick-add.nutrition.carbsPlaceholder': '42',
  'quick-add.nutrition.carbsUnit': 'г',
  'quick-add.nutrition.categoryDescription': 'Записать приём пищи',
  'quick-add.nutrition.categoryLabel': 'Питание',
  'quick-add.nutrition.demoProduct.apple': 'Яблоко',
  'quick-add.nutrition.demoProduct.banana': 'Банан',
  'quick-add.nutrition.demoProduct.milk': 'Молоко',
  'quick-add.nutrition.demoProduct.oatmealCooked': 'Овсянка варёная',
  'quick-add.nutrition.demoProduct.plainYogurt': 'Йогурт натуральный',
  'quick-add.nutrition.demoProduct.potatoBoiled': 'Картофель варёный',
  'quick-add.nutrition.demoProduct.riceBoiled': 'Рис варёный',
  'quick-add.nutrition.demoProduct.wholegrainBread': 'Цельнозерновой хлеб',
  'quick-add.nutrition.itemAriaLabel': 'Продукт',
  'quick-add.nutrition.itemCarbsLabel': 'Углеводы',
  'quick-add.nutrition.itemLabel': 'Продукт',
  'quick-add.nutrition.itemPlaceholder': 'Выберите продукт',
  'quick-add.nutrition.itemSheetTitle': 'Продукт',
  'quick-add.nutrition.itemsHeading': 'Продукты',
  'quick-add.nutrition.itemsHelp':
    'Демо-каталог используется только для интерфейса и не является медицинской или нормативной базой продуктов.',
  'quick-add.nutrition.mealTypeLabel': 'Тип приёма пищи',
  'quick-add.nutrition.mealTypePlaceholder': 'Выберите тип приёма пищи',
  'quick-add.nutrition.mealTypeSheetTitle': 'Тип приёма пищи',
  'quick-add.nutrition.mode.items': 'По продуктам',
  'quick-add.nutrition.mode.manual': 'Всего углеводов',
  'quick-add.nutrition.modeLegend': 'Способ добавления углеводов',
  'quick-add.nutrition.noteLabel': 'Заметка',
  'quick-add.nutrition.noteOptional': 'необязательно',
  ...
  'quick-add.nutrition.weightLabel': 'Вес порции',
