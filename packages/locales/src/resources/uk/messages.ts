...
export const ukrainianCanonicalMessages = defineApprovedMessages({
  ...
  'timeline.mealType.unspecified': 'Не вказано',
  ...
  'quick-add.nutrition.carbsError':
    'Введіть вуглеводи більше 0 і не більше 500 г.',
  'quick-add.nutrition.carbsLabel': 'Вуглеводи',
  'quick-add.nutrition.carbsPer100Label': 'г вуглеводів / 100 г',
  'quick-add.nutrition.carbsPlaceholder': '42',
  'quick-add.nutrition.carbsUnit': 'г',
  'quick-add.nutrition.categoryDescription': 'Записати прийом їжі',
  'quick-add.nutrition.categoryLabel': 'Харчування',
  'quick-add.nutrition.demoProduct.apple': 'Яблуко',
  'quick-add.nutrition.demoProduct.banana': 'Банан',
  'quick-add.nutrition.demoProduct.milk': 'Молоко',
  'quick-add.nutrition.demoProduct.oatmealCooked': 'Вівсянка варена',
  'quick-add.nutrition.demoProduct.plainYogurt': 'Йогурт натуральний',
  'quick-add.nutrition.demoProduct.potatoBoiled': 'Картопля варена',
  'quick-add.nutrition.demoProduct.riceBoiled': 'Рис варений',
  'quick-add.nutrition.demoProduct.wholegrainBread': 'Цільнозерновий хліб',
  'quick-add.nutrition.itemAriaLabel': 'Продукт',
  'quick-add.nutrition.itemCarbsLabel': 'Вуглеводи',
  'quick-add.nutrition.itemLabel': 'Продукт',
  'quick-add.nutrition.itemPlaceholder': 'Оберіть продукт',
  'quick-add.nutrition.itemSheetTitle': 'Продукт',
  'quick-add.nutrition.itemsHeading': 'Продукти',
  'quick-add.nutrition.itemsHelp':
    'Демокаталог призначений лише для інтерфейсу і не є медичною чи нормативною базою продуктів.',
  'quick-add.nutrition.mealTypeLabel': 'Тип прийому їжі',
  'quick-add.nutrition.mealTypePlaceholder': 'Оберіть тип прийому їжі',
  'quick-add.nutrition.mealTypeSheetTitle': 'Тип прийому їжі',
  'quick-add.nutrition.mode.items': 'Продукти',
  'quick-add.nutrition.mode.manual': 'Загальні вуглеводи',
  'quick-add.nutrition.modeLegend': 'Спосіб введення вуглеводів',
  'quick-add.nutrition.noteLabel': 'Нотатка',
  'quick-add.nutrition.noteOptional': 'необовʼязково',
  ...
  'quick-add.nutrition.weightError':
    'Вага має бути більше 0 і не більше 3000 г.',
  'quick-add.nutrition.weightLabel': 'Вага порції',
