...
const LOCALES: readonly LocaleMatrix[] = [
  ...
  },
  {
    ...
    quickAddGlucose: 'Schnell hinzufügen: Glukose',
    quickAddInsulin: 'Schnell hinzufügen: Insulin',
  ...
  },
  {
    ...
    quickAddGlucose: 'Швидке додавання: Глюкоза',
    quickAddInsulin: 'Швидке додавання: Інсулін',
