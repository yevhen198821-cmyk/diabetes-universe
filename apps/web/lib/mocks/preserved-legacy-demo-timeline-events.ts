...
/**
 * Preserved legacy demo dataset (schema v0) for migration/import regression only.
 *
 * Production runtime seeds the semantic-native `timelineEvents` export instead.
 */
...
export const preservedLegacyDemoTimelineEvents: readonly TimelineEvent[] = [
  {
