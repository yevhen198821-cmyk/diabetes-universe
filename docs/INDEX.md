...
- [Dashboard Recent Events Localization Migration (I18N-02B4)](architecture/localization/dashboard-recent-events-migration.md) — Feature Complete
- [Dashboard AI Insight Localization Migration (I18N-02B5)](architecture/localization/dashboard-ai-insight-migration.md) — Feature Complete
...
- [EA-001 — Next Action Engine Epic Architecture](architecture/dashboard/ea-001-next-action-engine-epic-architecture.md) — Feature Slice Complete; Standard Rule Contract
...
- [Encyclopedia](architecture/encyclopedia/overview.md)
- [Marketplace](architecture/marketplace/overview.md)
- [Reminders](architecture/reminders/overview.md)
- [My Health](architecture/my-health/overview.md)
...
- [P8 — Medical API Transport Implementation](implementation/p8-medical-api-transport.md) — routes merged; implementation candidate; production launch deferred
...
- [P10 — Local Data Adoption Foundation Implementation](implementation/p10-local-data-adoption-foundation.md) — implementation candidate
...
- [Dashboard Header](specs/dashboard/header.md)
- [Dashboard Next Action](specs/dashboard/next-action.md)
- [Dashboard Last Glucose](specs/dashboard/last-glucose.md)
- [Dashboard Day Summary](specs/dashboard/day-summary.md)
...
- [Recipe Entity](data/entities/recipe.md)
- [AI Insight Entity](data/entities/ai-insight.md)
