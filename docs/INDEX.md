...
- [Application Platform Integration](architecture/presentation/application-platform-integration.md) — CR-03C, Implementation Complete — Ready for Review (ADR-0013)
