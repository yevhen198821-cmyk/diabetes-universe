...
- **NA-001** (Architecture Revision Ready for Re-Audit): Glucose Data Staleness
  Rule — defines policy-bound rule architecture with implementation gate pending
  approved Glucose Data Staleness Policy; no rule implementation is included —
