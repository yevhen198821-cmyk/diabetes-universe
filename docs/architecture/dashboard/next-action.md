...
- **NA-001** (Repository Implementation): Glucose Data Staleness Rule —
  implements the policy-bound contextual rule that consumes GP-001 Policy Results
  only; Engineering Review remains pending —
