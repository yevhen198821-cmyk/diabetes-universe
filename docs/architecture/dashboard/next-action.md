...
- **GP-001** (Repository Implementation): Glucose Data Staleness Policy —
  defines the future governed platform policy that glucose staleness consumers
  must use instead of rederiving staleness independently —
