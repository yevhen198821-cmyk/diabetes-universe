...
- **GP-001** (Architecture Audit Ready for Review): Glucose Data Staleness
  Policy — defines the future governed platform policy that glucose staleness
  consumers must use instead of rederiving staleness independently —
