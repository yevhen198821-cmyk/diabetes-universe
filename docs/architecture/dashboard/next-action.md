...
- **GP-001** (Architecture Draft Ready for Architecture Audit): Glucose Data
  Staleness Policy — defines the future governed platform policy that glucose
  staleness consumers must use instead of rederiving staleness independently —
