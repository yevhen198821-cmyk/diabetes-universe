...
Feature Complete (CR-03B); Application Platform Integration Feature Complete
(CR-03C, [ADR-0013](../../adr/0013-web-client-runtime-ownership.md));
...
| Application platform integration  | CR-03C — Feature Complete (ADR-0013) |
